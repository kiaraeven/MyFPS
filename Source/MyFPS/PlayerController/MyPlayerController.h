...
protected:
	...
	*/
	...
	float TimeSyncFrequency = 5.f; // every 5 sec sync the time
	float TimeSyncRunningTime = 0.f; // how much time passed since last time sync
...
private:
	...
	UPROPERTY()
	class AMyGameMode* CharacterGameMode;
